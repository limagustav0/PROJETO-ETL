...
O objetivo central é extrair os dados da API pública da receita federal, estruturar todas as colunas de dados com Python e inserir as informações via conexão com o SQL SERVER, após isso, é feito o processo de transformação dos dados em informação utilizando o Microsoft Power BI Desktop.
